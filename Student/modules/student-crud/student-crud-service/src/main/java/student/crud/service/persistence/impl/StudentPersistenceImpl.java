...
package student.crud.service.persistence.impl;
...
import student.crud.exception.NoSuchStudentException;
import student.crud.model.Student;
import student.crud.model.StudentTable;
import student.crud.model.impl.StudentImpl;
import student.crud.model.impl.StudentModelImpl;
import student.crud.service.persistence.StudentPersistence;
import student.crud.service.persistence.StudentUtil;
import student.crud.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	public List<Student> findAll(
		...
		/*
		 * if (useFinderCache) { list = (List<Student>)finderCache.getResult(finderPath,
		 * finderArgs, null); }
		 */
